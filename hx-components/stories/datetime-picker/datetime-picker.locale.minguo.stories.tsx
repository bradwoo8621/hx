...
export const ZhRoc1582: Story = {
	render: (args) => {
		return <HxGrid gapX="lg" gapY="lg">
			...
			<HxSeparator gCols={12}/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1582/10/14'})} calendarLocale="zh-TW"
			             label="Short months, aligned with Gregorian dates, #1 — zh-TW"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1582/10/15'})} calendarLocale="zh-TW"
			             label="Short months, aligned with Gregorian dates, #2 — zh-TW"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1582/12/31'})} calendarLocale="zh-TW"
...
export const ZhRocJulianLeap: Story = {
	render: (args) => {
		return <HxGrid gapX="lg" gapY="lg">
			...
			<LocaleStory {...args} $model={ERO.reactive({date: '0200/02/28'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 0200 (ROC -1712)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '0300/03/01'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 0300 (ROC -1612)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '0500/03/02'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 0500 (ROC -1412)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '0600/03/03'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 0600 (ROC -1312)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '0700/03/04'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 0700 (ROC -1212)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '0900/03/05'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 0900 (ROC -1012)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1000/03/06'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 1000 (ROC -912)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1100/03/07'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 1100 (ROC -812)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1300/03/08'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 1300 (ROC -612)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1400/03/09'})} calendarLocale="zh-TW"
			             label="Julian Leap Year 1400 (ROC -512)"/>
			<LocaleStory {...args} $model={ERO.reactive({date: '1500/03/10'})} calendarLocale="zh-TW"
...
export const ZhRocEra: Story = {
	render: (args) => {
		return <HxGrid gapX="lg" gapY="lg">
			...
			<LocaleStory {...args} $model={ERO.reactive({date: '2026/07/21'})} calendarLocale="zh-TW"
			             label="Someday 2026"/>
		</HxGrid>;
	}
};
