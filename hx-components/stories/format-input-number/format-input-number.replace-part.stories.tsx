...
export const ReplaceShorterWithinLimit: Story = {
	render: () => <Fixture
		...
		initialValue={12345}
		test={input => firePaste(input, '9', [1, 3])}/>
};
...
export const ReplaceLongerWithinLimit: Story = {
	render: () => <Fixture
		...
		initialValue={12345}
		test={input => firePaste(input, '678', [1, 3])}/>
};
...
export const ReplaceExceedMaxInteger: Story = {
	render: () => <Fixture
		...
		initialValue={123}
		test={input => firePaste(input, '45678', [0, 2])}/>
};
...
export const ReplaceExceedMaxIntegerTruncated: Story = {
	render: () => <Fixture
		...
		initialValue={123}
		test={input => firePaste(input, '4567', [1, 3])}/>
};
...
export const ReplaceWithDecimalPoint: Story = {
	render: () => <Fixture
		...
		initialValue={12345}
		test={input => firePaste(input, '.', [1, 4])}/>
};
...
export const ReplaceWithDigitAndDecimal: Story = {
	render: () => <Fixture
		...
		initialValue={12345}
		test={input => firePaste(input, '.6', [1, 4])}/>
};
...
export const ReplaceWithDecimalExceedFraction: Story = {
	render: () => <Fixture
		...
		initialValue={1234}
		test={input => firePaste(input, '.567', [1, 3])}/>
};
...
export const ReplaceStartWithMinus: Story = {
	render: () => <Fixture
		...
		initialValue={123}
		test={input => firePaste(input, '-', [0, 2])}/>
};
...
export const ReplaceMiddleWithMinus: Story = {
	render: () => <Fixture
		...
		initialValue={12345}
		test={input => firePaste(input, '-', [1, 3])}
		testManually={true}/>
};
...
export const ReplaceWithIllegalChars: Story = {
	render: () => <Fixture
		...
		initialValue={1234}
		test={input => firePaste(input, 'abc', [2, 4])}
		testManually={true}/>
};
...
export const ReplaceWithMixedIllegalChars: Story = {
	render: () => <Fixture
		...
		initialValue={1234}
		test={input => firePaste(input, '5a6b', [2, 4])}/>
};
...
export const ReplaceFractionWithinLimit: Story = {
	render: () => <Fixture
		...
		initialValue={1.234}
		test={input => firePaste(input, '89', [3, 4])}/>
};
...
export const ReplaceFractionExceedLimit: Story = {
	render: () => <Fixture
		...
		initialValue={1.23}
		test={input => firePaste(input, '456', [2, 4])}/>
};
...
export const ReplaceFractionAtMax: Story = {
	render: () => <Fixture
		...
		initialValue={1.23}
		test={input => firePaste(input, '45', [3, 4])}/>
};
...
export const ReplaceBeforeDecimalInSuffix: Story = {
	render: () => <Fixture
		...
		initialValue={12.34}
		test={input => firePaste(input, '89', [0, 2])}/>
};
...
export const ReplaceBeforeDecimalExceedMaxInteger: Story = {
	render: () => <Fixture
		...
		initialValue={12.34}
		test={input => firePaste(input, '345', [0, 2])}/>
};
...
export const ReplaceWithZeroWhenMaxIntegerZero: Story = {
	render: () => <Fixture
		...
		initialValue={12}
		test={input => firePaste(input, '0', [0, 2])}/>
};
...
export const ReplaceWithNonZeroWhenMaxIntegerZero: Story = {
	render: () => <Fixture
		...
		initialValue={0}
		test={input => firePaste(input, '5', [0, 1])}
		testManually={true}/>
};
...
export const ReplaceWithMinusUnsigned: Story = {
	render: () => <Fixture
		...
		initialValue={123}
		test={input => firePaste(input, '-5', [0, 2])}
		testManually={true}/>
};
...
export const ReplaceAcrossGrouping: Story = {
	render: () => <Fixture
		...
		test={input => firePaste(input, '89', [3, 6])}/>
};
...
export const ReplaceWithGroupingInText: Story = {
	render: () => <Fixture
		...
		initialValue={12345}
		test={input => firePaste(input, '6,78', [1, 4])}/>
};
...
export const ReplaceWithLeadingGrouping: Story = {
	render: () => <Fixture
		...
		initialValue={1234}
		test={input => firePaste(input, ',56', [3, 5])}/>
};
...
export const ReplaceIntegerInNegativeDecimal: Story = {
	render: () => <Fixture
		...
		initialValue={-12.34}
		test={input => firePaste(input, '89', [1, 3])}/>
};
...
export const ReplaceFractionInNegativeDecimal: Story = {
	render: () => <Fixture
		...
		initialValue={-12.34}
		test={input => firePaste(input, '5', [4, 6])}/>
};
...
export const ReplaceBeforeDecimalSuffixHasDecimal: Story = {
	render: () => <Fixture
		...
		initialValue={123.45}
		test={input => firePaste(input, '67', [2, 3])}/>
};
