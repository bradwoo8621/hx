...
describe('Japanese era boundaries', () => {
	const eras: Array<[string, Date, Date]> = [
		...
		['嘉慶', new Date(Date.UTC(1387, 7, 31)), new Date(Date.UTC(1389, 1, 16))],
		...
		['正嘉', new Date(Date.UTC(1257, 2, 21)), new Date(Date.UTC(1259, 3, 1))],
		...
		['延応', new Date(Date.UTC(1239, 1, 14)), new Date(Date.UTC(1240, 6, 22))],
		...
		['嘉禄', new Date(Date.UTC(1225, 3, 27)), new Date(Date.UTC(1227, 11, 16))],
		...
		['寿永', new Date(Date.UTC(1182, 5, 3)), new Date(Date.UTC(1184, 3, 22))],
		...
		['康治', new Date(Date.UTC(1142, 4, 5)), new Date(Date.UTC(1144, 1, 29))],
