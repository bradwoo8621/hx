...
export class DateIslamicCivilUtils extends DateMoveIslamicSharedUtils implements DateLocaleNotGregorianProvider {
	...
	/** Returns the list of locales that use the Islamic Civil calendar. */
	...
	/**
	 * Registers the Islamic Civil calendar with the locale and move providers.
	 */
	static enable() {
	...
	/**
	 * Unregisters the Islamic Civil calendar from the locale and move providers.
	 */
	static disable() {
