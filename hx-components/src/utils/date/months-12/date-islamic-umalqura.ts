...
export class DateIslamicUmalquraUtils extends DateMoveIslamicSharedUtils implements DateLocaleNotGregorianProvider {
	...
	/** Returns the list of locales that use the Islamic Umalqura calendar. */
	...
	/**
	 * Registers the Islamic Umalqura calendar with the locale and move providers.
	 */
	static enable() {
		DateLocaleFormatUtils.enableNotGregorianLocaleProvider(DateIslamicUmalquraUtils.INSTANCE);
		DateMoveUtils.enableNotGregorianMoveProvider(DateIslamicUmalquraUtils.INSTANCE);
	}

	/**
	 * Unregisters the Islamic Umalqura calendar from the locale and move providers.
	 */
	static disable() {
		DateLocaleFormatUtils.disableNotGregorianLocaleProvider(DateIslamicUmalquraUtils.INSTANCE);
		DateMoveUtils.disableNotGregorianMoveProvider(DateIslamicUmalquraUtils.INSTANCE);
	}
	 ...
	 * first representable day (month 5 day 18) to the end of the year.
	 */
	 ...
	 * calendar year (−640); month 5 starts at day 18, the other months at day 1.
	 */
