...
export type HxWithCheckPropsWithoutRef<T extends object, P extends object> = PropsWithoutRef<P & CheckProps<T>>;
export const HxWithCheck =
	<P extends object>(C: HxWithCheckOrgFC<P>) => {
		return forwardRef(<T extends object>(props: HxWithCheckPropsWithoutRef<T, P>, ref: ForwardedRef<HTMLDivElement>) => {
