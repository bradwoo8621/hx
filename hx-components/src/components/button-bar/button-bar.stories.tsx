		...
		<div style={{width: '600px', display: 'flex', flexDirection: 'column', gap: '32px'}}>
			...
			<HxPanel title="Basic Dual Button Bar" bodyPaddingT="lg">
				<HxButtonBar gCols={12} paddingX="none" paddingT="none"
				             leading={<HxButton $model={model} various="outline" color="info" text="Save Draft"
				                                onClick={handleClick('Save Draft')}/>}
				             tailing={<>
					             <HxButton $model={model} various="ghost" color="waive" text="Cancel"
					                       onClick={handleClick('Cancel')}/>
					             <HxButton $model={model} various="solid" color="primary" text="Submit"
			...
			<HxPanel title="Left Aligned Button Bar" bodyPaddingT="lg">
				<HxButtonBar gCols={12} paddingX="none" paddingT="none"
				             leading={<>
					             <HxButton $model={model} various="solid" color="primary" text="Previous"
					                       onClick={handleClick('Previous')}/>
					             <HxButton $model={model} various="outline" color="primary" text="Next"
			...
			<HxPanel title="Right Aligned Button Bar" bodyPaddingT="lg">
				<HxButtonBar gCols={12} paddingX="none" paddingT="none"
				             tailing={<>
					             <HxButton $model={model} various="ghost" color="waive" text="Reset"
					                       onClick={handleClick('Reset')}/>
					             <HxButton $model={model} various="solid" color="danger" text="Delete"
		...
		<div style={{width: '600px', display: 'flex', flexDirection: 'column', gap: '32px'}}>
			...
			<HxPanel title="Custom Button Spacing" bodyPaddingT="lg">
				<HxButtonBar gCols={12} gapX="lg" paddingX="none" paddingT="none"
				             leading={<>
					             <HxButton $model={model} various="outline" text="Button 1"
					                       onClick={handleClick('Button 1')}/>
					             <HxButton $model={model} various="outline" text="Button 2"
					                       onClick={handleClick('Button 2')}/>
					             <HxButton $model={model} various="outline" text="Button 3"
			...
			<HxPanel title="Custom Container Padding" bodyPaddingT="lg" style={{background: '#f5f5f5'}}>
				<HxButtonBar gCols={12}
				             ...
				             leading={<HxButton $model={model} various="ghost" text="Back"
				                                onClick={handleClick('Back')}/>}
				             tailing={<>
					             <HxButton $model={model} various="outline" text="Export"
					                       onClick={handleClick('Export')}/>
					             <HxButton $model={model} various="solid" text="Import"
			...
			<HxPanel title="Form Action Bar" bodyPaddingT="lg">
				<HxButtonBar gCols={12} paddingX="none" paddingT="none"
				             leading={<>
					             <HxButton $model={model} various="ghost" color="info" text="Help"
					                       onClick={handleClick('Help')}/>
					             <HxButton $model={model} various="ghost" color="warn" text="Preview"
					                       onClick={handleClick('Preview')}/>
				             </>}
				             tailing={<>
					             <HxButton $model={model} various="ghost" color="waive" text="Cancel"
					                       onClick={handleClick('Cancel')}/>
					             <HxButton $model={model} various="outline" color="success" text="Save"
					                       onClick={handleClick('Save')}/>
					             <HxButton $model={model} various="solid" color="primary" text="Publish"
