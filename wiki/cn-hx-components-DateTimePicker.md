...
- **希伯来历** — 月份面板已实现（年份面板尚未实现）；希伯来历范围 [3761, 13760] 两端均为不完整年，因此 3761 年 1-3 月标记为 `bc`，13760 年 3-12 月标记为 `y10k`。月份按民用月序编号（1 = Tishrei）；闰年时 Adar 拆分为 Adar I / Adar II，网格追加第 13 个月（Elul）。
